...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        SanPedro.addDoctor(new Doctor("342121331D","Paco","Pérez","Traumatology",53423,30,"653534234"));
        SanPedro.addDoctor(new Doctor("34765433G","Fulgencio","Fulgencius","Traumatology",53000,35,"653534855"));
